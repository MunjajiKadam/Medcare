    ...
    <div className={`mb-4 ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full px-4 ${icon ? 'pl-10' : ''} py-2.5 border rounded-lg transition focus:outline-none focus:ring-2 disabled:bg-gray-100 dark:disabled:bg-gray-700 disabled:cursor-not-allowed bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 ${
            displayError 
              ? 'border-red-500 dark:border-red-400 focus:ring-red-200 focus:border-red-500' 
