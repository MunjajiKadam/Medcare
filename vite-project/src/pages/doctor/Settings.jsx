...
export default function DoctorSettings() {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      console.log("✅ [DOCTOR SETTINGS] Password changed successfully:", response.data.message);
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-semibold transition-colors ${twoFactorEnabled
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-semibold transition-colors ${notification
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-semibold transition-colors ${newsletter
                      ? "bg-blue-600 text-white hover:bg-blue-700"
                      : "bg-gray-300 text-gray-700 hover:bg-gray-400"
                    }`}
